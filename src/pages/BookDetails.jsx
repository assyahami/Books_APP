...
const BookDetails = (props) => {
    ...
    let { author, country, year, id, language, title, link, pages } = getDetails.state
    return (
        <div>
            <Header />
            <div>
                <div className='title_header p-md '>
                    <h2 className='title_head_md'>Book details</h2>
            ...
            <div className='book-details'> 
                ...
                <div className='book-info'>
                    ...
                    <div><strong>Country:</strong> <span>{country || "India"}</span></div>
                    <div><strong>Language:</strong> <span>{language || "EN"}</span></div>
                    <div><strong>Pages:</strong> <span>{pages}</span></div>
                    <div><strong>Link:</strong> <a href={"#"} target='__blank'>{link || ""}</a></div>
